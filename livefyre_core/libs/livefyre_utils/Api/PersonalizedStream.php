...
require_once(dirname(__FILE__) . '/../Routing/Client.php');
require_once(dirname(__FILE__) . '/../Entity/Topic.php');
require_once(dirname(__FILE__) . '/../Entity/Subscription.php');
require_once(dirname(__FILE__) . '/../Entity/SubscriptionType.php');
require_once(dirname(__FILE__) . '/../Utils/JWT.php');
require_once(dirname(__FILE__) . '/../Api/Domain.php');
...
class PersonalizedStream {
	...
	public static function createOrUpdateTopic($core, $id, $label) {
		$resp = self::createOrUpdateTopics($core, array($id => $label));
		return $resp[0];
	}
